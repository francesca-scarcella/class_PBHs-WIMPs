...
from .model import annihilating_model, decaying_model, evaporating_model, annihilating_halos_model, accreting_model, annihilating_spikes_model
#,annihilation_clump
...
def loading_from_specfiles(fnames, transfer_functions, mass,  logEnergies=None, redshift=None, t_dec=np.inf,zh=1.,fh=0., PBH_mass=0., fPBH=0., sigmav=0., spikeprofiles=0,  hist='annihilation', branchings=[1.], **DarkOptions):
    ...
    elif hist == 'annihilation_spikes':
        model_from_file = annihilating_spikes_model(tot_spec[0], tot_spec[1], tot_spec[2], 1e9*mass,PBH_mass,fPBH, sigmav,spikeprofiles,logEnergies,redshift, **DarkOptions)
        #print_info("calling annihilating_spikes_model")
    else:
